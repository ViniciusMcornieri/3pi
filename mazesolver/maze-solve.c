...
unsigned char max_speed_solved = 80;//the max value of the speed for repeat the solution of the maze
unsigned char max_speed_solving = 60;//the max value of the speed for search for a solution for the maze
...
void maze_solve()
{
	...
	while(1)
	{
		...
		follow_segment(max_speed_solving);
    ...
    while(1)
    {
       ...
       play(">>a32");
		...
		for(i=0;i<path_length;i++)
		{
			...
			follow_segment(max_speed_solved);
            ...
            if(path[i]!='S'){
                ...
                set_motors(max_speed_solved, max_speed_solved);
                    delay_ms(150);
            }
